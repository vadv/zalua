...
* *plugin_parser*: позволяет загрузить при помощи https://golang.org/pkg/plugin/ библиотеку с интерфейсом: `type Parser interface { ProcessData(string) (map[string]string, error) }`
